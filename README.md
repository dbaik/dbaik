...
**Web Developer** · WordPress · Shopify · Frontend
...
- Build Gutenberg blocks, ACF setups, Elementor, and Polylang when the brief needs them
- Write Shopify Liquid: reusable sections, products, collections, variants, quote and artwork-upload flows
- Frontend: PHP, HTML/CSS, SCSS, JavaScript, jQuery, AJAX, GSAP / ScrollTrigger
- Keep pages fast: Core Web Vitals, media optimisation, semantic HTML
...
**CMS:** WordPress (Gutenberg, ACF, Elementor, Polylang) · Shopify (Liquid, sections, variants) · Drupal (some theme and frontend work) · also Webflow, Magento  
**Motion:** GSAP, ScrollTrigger, Anime.js, AOS  
**Data / tooling:** MySQL, Gulp, Webpack, Vite · Git, GitHub, Bitbucket  
**Tracking:** Google Analytics, GTM, Meta Pixel
